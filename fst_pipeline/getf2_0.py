#!/bin/python
fw = open('/disk-1/song/NHT130112/releaseData/re_call/sliding_win/f2_0.vcf','w')
with open('/disk-1/song/NHT130112/releaseData/re_call/sliding_win/f0_1.vcf') as file1:
    with open('/disk-1/song/NHT130112/releaseData/re_call/sliding_win/No1.blast') as file2:
